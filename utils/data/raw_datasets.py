...
class PvduySharegptalpacaoavicunaformatDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        data_files = {}
        data_files["train"] = '/home/dist/dataset/sharegpt_alpaca_oa_vicuna_format/data/train-00000-of-00001-23ed8d98fe776723.parquet'
        data_files["test"] = '/home/dist/dataset/sharegpt_alpaca_oa_vicuna_format/data/test-00000-of-00001-d6826e90444ee019.parquet'
        self.raw_datasets = load_dataset("parquet", data_files=data_files)
